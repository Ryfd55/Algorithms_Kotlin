...
fun main() {
     ...
     * Чувства Халка состоят из n уровней. Первый из них - это ненависть, второй - любовь, третий снова ненависть и т.д.
     * Например, для n = 1 чувства Халка выражаются как "I hate it", для n = 2 это уж "I hate that I love it", а для n = 3 -
     * "I hate that I love that I hate it"
     * Помогите Брюсу выразить чувства на n-ом уровне погружения& (для n от 1 до 100)
     */
    val n = 3
    println(level(n))
}
